...
router.post('/appointment',async(req,res)=>{
    ...
    const visitsInMonth = await Appointment.find({$and: [{patient: patient._id}, {date: {$gt: firstDayCurrentMonth}},{date:{$lt: lastDayCurrentMonth}}]});
...
router.get('/appointment',async(req,res)=>{
    ...
    try{
        const appointment= await Appointment.find(query,{},{skip, limit}).populate('personel').populate('patient')
